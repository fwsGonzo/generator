...
# -g -Og
BUILDOPT = -Ofast -mfpmath=both -march=native -Wno-unused-result
# output file
OUTPUT   = ./generator

# code folder
SOURCE = src terrain terrain/biome terrain/noise \
		terrain/objects terrain/structures \
		terrain/generators/flat terrain/generators/std
